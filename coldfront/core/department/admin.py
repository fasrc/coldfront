...
class DepartmentAdmin(SimpleHistoryAdmin):
    ...
    inlines = [DepartmentParentsInline, DepartmentContactsInline, UserAffiliationInlineAdmin]
...
class DepartmentMemberAdmin(SimpleHistoryAdmin):
    ...
    list_filter = ('organization', STATUS_FIELD)
    search_fields = (MEMBER_FIELD, DEPARTMENT_FIELD)
    raw_id_fields = ('organization', MEMBER_FIELD, )
